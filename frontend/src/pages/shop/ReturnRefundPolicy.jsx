...
export default function ReturnRefundPolicy() {
  return (
    <div className="section max-w-4xl mx-auto py-16">
      ...
      <p className="mb-4">At Kesara Bathik, every garment is handcrafted using traditional Sri Lankan batik techniques. Slight variations in color and patterns are natural characteristics of handmade batik and make each piece unique.</p>
      ...
      <p className="mb-2"><strong>Our Error:</strong> If we shipped an incorrect item or the item has a manufacturing defect, Kesara Bathik will cover all return shipping costs.</p>
