          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="card p-6 h-fit sticky top-20">
              ...
              <div className="space-y-2 text-sm mb-4">
                ...
                <div className="flex justify-between text-gray-500"><span>Shipping</span><span>{shipping() === 0 ? <span className="text-green-600 font-semibold">FREE 🎉</span> : format(shipping())}</span></div>
                {shipping() > 0 && <p className="text-xs text-gray-400">Free shipping on orders over CA$120</p>}
