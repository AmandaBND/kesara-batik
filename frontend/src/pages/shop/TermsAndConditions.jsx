...
export default function TermsAndConditions() {
  return (
    <div className="section max-w-4xl mx-auto py-16">
      ...
      <p className="mb-4">Welcome to Kesara Bathik. By accessing our website or placing an order, you agree to the following Terms and Conditions.</p>
      ...
      <p className="mb-2">Sri Lankan customers are shown the separately maintained LKR product price list, and Dialog Genie charges that exact LKR total. International prices are based on the CAD product price and converted into the selected display currency using the current CAD exchange rate. For overseas Genie payments, the order remains displayed and recorded in the selected currency, while the independent CAD base total is converted to an LKR gateway amount because the merchant account settles Genie transactions in LKR. Overseas product prices are never taken from the separate Sri Lankan priceLKR list. Your card issuer may still apply its own fees or conversion rules.</p>
      ...
      <p className="mb-4">All content on this website, including logos, product photographs, text, graphics, website design, batik artwork and patterns remains the exclusive property of Kesara Bathik.</p>

      <h2 className="text-lg font-semibold mt-6 mb-2">6. Limitation of Liability</h2>
      <p className="mb-4">Kesara Bathik shall not be liable for indirect, incidental, or consequential damages arising from the use of our products or services.</p>
      ...
      <p className="font-semibold">Kesara Bathik<br/>Email: kesarabatik.info@gmail.com<br/>Phone: +94 77 488 1013</p>
    </div>
  )
}
